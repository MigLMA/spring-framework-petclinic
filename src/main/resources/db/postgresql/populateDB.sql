...
INSERT INTO Users VALUES (1, 'useradmin', '$2y$10$yIng7EHQ5NZjRai3FnkXmeRzc8Dwwf5DcuR3dNL7rN5x6isqWWBRS') ON CONFLICT DO NOTHING; -- password
INSERT INTO Users VALUES (2, 'barrywhite', '$2y$10$o878kaEOoDDUOv.moPtJHuErKNolTraqQ6OVP4CdWYZ5gq3k74UiW') ON CONFLICT DO NOTHING; -- Enunlugardelamancha
INSERT INTO Users VALUES (3, 'johndoe', '$2y$10$iIOen5rPUwwvwNdYO5Ai4uAPFf8tu2lGP2.qnxyFm.ltTXhi4P0Em') ON CONFLICT DO NOTHING; -- johndoe1234

INSERT INTO Roles VALUES (1, 'admin') ON CONFLICT DO NOTHING;
INSERT INTO Roles VALUES (2, 'dba') ON CONFLICT DO NOTHING;
INSERT INTO Roles VALUES (3, 'user') ON CONFLICT DO NOTHING;

INSERT INTO UserRoles VALUES(1,1) ON CONFLICT DO NOTHING;
INSERT INTO UserRoles VALUES(1,2) ON CONFLICT DO NOTHING;
INSERT INTO UserRoles VALUES(1,3) ON CONFLICT DO NOTHING;
INSERT INTO UserRoles VALUES(2,3) ON CONFLICT DO NOTHING;
INSERT INTO UserRoles VALUES(3,3) ON CONFLICT DO NOTHING;
